<?php
    ...
    */
    ...
    $array_perm_text = array(
            ...
            '<i class="fa fa fa-clock-o"></i> Time Off',
            '<i class="fa fa fa-money"></i> Assets');
   ...
   $array_intervals = array(
    ...
    function upload_file_to_alibaba($file)
	{
